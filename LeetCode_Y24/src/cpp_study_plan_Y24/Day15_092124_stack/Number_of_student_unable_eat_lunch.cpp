/*
 * Number_of_student_unable_eat_lunch.cpp
 *
...
int countStudents(int* students,int nStudent, int* sandwiches, int nSandwiches){
	...
	int remaining = nSandwiches;

	for (int j = 0; j < nSandwiches; j++){
